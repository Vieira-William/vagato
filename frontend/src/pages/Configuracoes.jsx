                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    {(!calendarConnected || !gmailConnected || !tasksConnected) && (
                      <Button
                        ...
                        className="w-full h-12 gap-3 rounded-xl bg-white dark:bg-card border dark:border-border hover:border-[#4285F4]/40 hover:bg-[#4285F4]/5 text-foreground font-bold text-[11px] uppercase tracking-widest shadow-sm transition-all"
                        variant="outline"
                      >
